# MegaLinter Custom Flavor: aviation-concepts

This custom MegaLinter aims to have an optimized Docker image size.

It is built from official MegaLinter images, but is maintained on https://github.com/JonathanR-SFDC/megalinter-custom-flavor-aviation-concepts by Jonathan Ramirez
...
## Embedded linters
  ...
  - [SALESFORCE_LIGHTNING_FLOW_SCANNER](https://megalinter.io/latest/descriptors/salesforce_lightning_flow_scanner/)
  - [SALESFORCE_SFDX_SCANNER_APEX](https://megalinter.io/latest/descriptors/salesforce_sfdx_scanner_apex/)
  - [SALESFORCE_SFDX_SCANNER_AURA](https://megalinter.io/latest/descriptors/salesforce_sfdx_scanner_aura/)
  - [SALESFORCE_SFDX_SCANNER_LWC](https://megalinter.io/latest/descriptors/salesforce_sfdx_scanner_lwc/)
...
- GitHub Action: On MegaLinter step in .github/workflows/mega-linter.yml, define `uses: JonathanR-SFDC/megalinter-custom-flavor-aviation-concepts@main`
- Docker image: Replace official MegaLinter image with `ghcr.io/JonathanR-SFDC/megalinter-custom-flavor-aviation-concepts/megalinter-custom-flavor:latest`
